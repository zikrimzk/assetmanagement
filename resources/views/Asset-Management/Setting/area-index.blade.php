    ...
    <div class="main-content app-content">
        <div class="container">
            ...
            <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
                <h1 class="page-title fw-semibold fs-22 mb-0">Area Management</h1>
                ...
                <div class="mb-5">
                    ...
                    <div class="card custom-card shadow-sm">
                        <div class="card-header">
                            ...
                            <button class="btn btn-light me-2" data-bs-toggle="modal" data-bs-target="#modalAddAreaExcel">
                            ...
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a class="dropdown-item" href="{{ route('area-export-excel-get') }}">Excel <span
                                                class="fw-bolder">(.xlsx)</span> </a></li>
                                    <li><a class="dropdown-item" href="{{ route('area-export-pdf-get') }}">Pdf <span
            ...
            <div class="row">
                    ...
                    <div class="modal-dialog modal-dialog-centered text-center">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h6 class="modal-title">Area Details</h6><button aria-label="Close" class="btn-close"
                                ...
                                <div class="modal-body text-start">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-12 mb-2">
                                            <label for="input-placeholder" class="form-label">Area Name <span
                                        ...
                                        {{-- Code  --}}
                                        <div class="col-sm-12 mb-2">
                                            <label for="input-placeholder" class="form-label ">Area Code <span
                                                    class="text-danger fw-bold">*</span> </label>
                ...
                <div class="modal fade" id="modalAddAreaExcel">
                    <div class="modal-dialog modal-dialog-centered text-center">
                        <div class="modal-content">
                            <div class="modal-header">
                            ...
                            <form action="{{ route('area-import-post') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="modal-body text-start">
                                    <div class="row">
                                        {{-- Name --}}
                                        ...
                                        <div class="col-sm-12 mb-2">
                                            <p class="fw-semibold">You can download the
                                                template 
                                            <a href="../TemplateExcel/AssetTrack-Area-Template.xlsx" class="text-danger text-decoration-underline" 
                                                download>here</a>.
                                            </p>
                                        </div>
                                    </div>
                ...
                @foreach ($areas as $area)
                    <div class="modal fade" id="modalUpdateArea-{{ $area->id }}">
                        <div class="modal-dialog modal-dialog-centered text-center">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h6 class="modal-title">Update Area </h6><button aria-label="Close" class="btn-close"
                                        data-bs-dismiss="modal"></button>
                                </div>

                                <form action="{{ route('area-edit-post', $area->id) }}" method="POST">
                                    @csrf
                                    <div class="modal-body text-start">
                                        <div class="row">
                                            {{-- Name --}}
                                            <div class="col-sm-12 mb-2">
                                                <label for="input-placeholder" class="form-label">Area Name <span
                                                        class="text-danger fw-bold">*</span> </label>
                                                <input type="text" class="form-control" name="area_name"
                                                    id="input-placeholder" required value="{{ $area->area_name }}">
                                            </div>
                                            {{-- Code  --}}
                                            <div class="col-sm-12 mb-2">
                                                <label for="input-placeholder" class="form-label ">Area Code <span
                                                        class="text-danger fw-bold">*</span> </label>
                                                <input type="text" class="form-control" name="area_code"
                                                    id="input-placeholder" required value="{{ $area->area_code }}">
                                            </div>
                                            {{-- Company --}}
                                            <div class="col-sm-12 mb-2">
                                                <label for="input-placeholder" class="form-label">Company <span
                ...
                @foreach ($areas as $area)
                    <div class="modal fade" id="modalDelete-{{ $area->id }}">
                        <div class="modal-dialog modal-dialog-centered text-center" role="document">
                            <div class="modal-content modal-content-demo">
                                <div class="modal-body text-center mb-3">
                                    ...
                                    <a href="{{ route('area-delete-get-post', $area->id) }}"
